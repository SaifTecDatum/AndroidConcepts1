...
import com.myapps.androidconcepts.Interfaces.WeatherApi;
...
public class WeatherRestClient {
    ...
    private OkHttpClient buildOkHttpClient() {
        ...
        //Above 2 lines to show our code in logcat if the app is in debug mode, developing mode
        // & restricting in the release mode bcoz not to hack our code by users who have release apk.
